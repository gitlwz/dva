...
let joinus = [
    {
        ...
        content: `
【岗位职责】
1.研究和了解区块链技术发展动向，参与区块链平台的产品规划，推进应用场景落地；
2.进行产品详细特性规划和系统原型设计，并协助研发团队理解和掌握需求；
3.持续做竞品分析、用户分析、数据分析，在运营中不断优化产品。
【任职要求】
1.对整个区块链市场有认知，了解技术结构，包括市场已发布的区块链产品优势和当前待开发的产品优势；
2.有良好的沟通协作力，有严密的逻辑分析能力和一定的技术理解能力；
3.熟悉互联网产品整体实现过程，包括需求分析和产品发布；
4.三年及以上互联网产品经验，有行业相关产品经验者优先。`
    }, {
        title: "交互设计师",
        content: `
【岗位职责】
1.进行企业服务产品的交互设计，提供全局设计方案，并对产品最终的用户体验负责；
2.进行线上线下推广、市场活动等的创意设计相关工作（平面设计、移动端网页设计）； 
3.参与公司品牌VI与相关视觉体系的规范建设。
【任职要求】
1.对用户体验、交互操作流程及用户需求有较深入理解；
2.能根据需求文档作出产品原型，对互联网产品风格有良好见解；
3.对交互设计有深刻的理解，能独立支持公司产品的交互设计工作；
4.设计相关专业毕业，1年以上UI设计经验，对UI设计趋势有灵敏触觉和领悟能力。`
    }, {
        title: '资深Java工程师',
        content: `
【岗位职责】
...
【任职要求】
1.对于大型系统的容错、高并发、低延迟有深刻认识；
2.具有丰富的Webservice和Restful API设计经验；
3.对开源技术有浓厚兴趣，比如SpringBoot，SpringCloud，Zookeeper等；
4.对JVM调优有丰富的实践经验，熟练使用VisualVM，JMC，DTrace等； 
5.五年以上软件开发经验，三年以上J2EE系统经验；具有互联网分布式项目经验者优先； 计算机及相关专业本科以上学历。`
    }, {
        title: 'Web前端工程师',
        content: `
【岗位职责】
...
3.保证快速迭代开发中的速度与质量。
【任职要求】
1.学习能力强，积极主动，具备良好分析问题、解决问题的能力；
2.精通angularjs、HTML5/CSS3、vue等技术，了解常用的前端框架原理；
3.计算机相关专业本科及以上学历，五年以上Web产品开发经验。`
    }, {
        title: '金融风控专家',
        content: `
【岗位职责】
...
2.审核项目资料的真实合法和准确全面；
3.对项目进行现场调查，完成相应风控报告，并提出建议及可控方案；
4.对风险项目提出风险预警，及时向公司报告，并参与风险事件的处置；
5.收集、整理国家及地方相关法律法规，并提出风险管理的合理化建议。
【任职要求】
1.有风控、信贷、审计工作经验者优先；
2.对经济、金融、财务、法律等多领域知识以及常见各行业有一定了解，具有较强的分析和学习能力，有风险识别和判断能力；
3.金融、经济、财务、法律、会计以及风险管理等相关专业，本科以上学历，五年以上工作经验。`
    }
]
let copyright = {
    title: "法律声明",
...
let privacy = {
    title: "隐私条款",
    content: `一.关于双方的定义
1.SUNDAX(Singapore) Technology Group Pte. Ltd.（以下称 “公司”）是一家依据新加坡共和国相关法律法规在新加坡共和国注册成立的公司，该公司运营网站https://www.sundax.top（以下称“本网站”或“网站”），该网站是一个致力于为全球用户提供数字资产交易及相关服务（以下称“该服务”或“服务”）的平台。该公司及该网站在本协议中合称使用“我们”或其他第一人称称呼；
...
七.关于个人资料的保护
我们通过术各方面的措施来保障阁下的个人资料的安全。我们努力确保通过本网站所搜集的任何个人资料免于任何与我们无关的第三者的滋扰。
我们采取的安全措施包括但不限于：
1.存有阁下个人资料的电脑数据会被存放在受严格登入限制的电脑系统和存储媒体上；
2.存有阁下个人资料的记录会被存放在安全的、有锁闭装置的地方；
3.采用各种加密技术来输送阁下的个人资料；
4.只有经我们授权的职员才能接触到阁下的个人资料, 这些职员需要遵守我们个人资料保密的内部守则；
5.我们的网络服务器受到“防火墙”的保护。
...
let userAgreement = {
    title: "用户协议",
    content: `SUNDAX(Singapore) Technology Group Pte. Ltd.（以下称“公司”）是一家依据新加坡共和国相关法律法规在新加坡共和国注册成立的公司，该公司运营网站https://www.sundax.top（以下称“本网站”或“网站”），该网站是一个致力于为全球用户提供数字资产交易及相关服务（以下称“该服务”或“服务”）的平台。网站所有内容，可能提供多个语言版本，若有冲突或遗漏等情况，以中文内容为准。

一.【定义】
1.本协议：指本协议正文、《隐私条款》、《了解你的客户和反洗钱政策》以及网站已经发布的或将来可能发布的各类规则、声明、说明等构成。
2.阁下（或其他第二人称）：登陆该网站的自然人或其他主体，即网站的用户。
3.我们（或其他第一人称）：SUNDAX(Singapore) Technology Group Pte. Ltd及https://www.sundax.top。
4.双方：我们和阁下在本协议中的合称。
5.一方：我们或阁下在本协议中的单称。
...
3.在进行注册过程中点击“同意”按钮，即表示阁下以电子签署的形式与公司达成协议；或阁下在使用网站过程中点击任何标有“同意”或类似意思的按钮的行为或以其他本网站允许的方式实际使用我们提供的服务时，均表示阁下完全了解、同意且接受本协议项下的全部条款的约束，无阁下手写的书面签字就本协议对阁下的法律约束力无任何影响。
...
五.【网站规则】
1.网站唯一官方对外信息公布平台是https://www.sundax.top。
...
E.如果该公司的主要营业地址与公司的邮寄地址不同，提供邮寄地址；
F.如果公司在本地的地址与它的主要营业地址不一致的，则被视为风险较高的客户，需要提交额外附加文件：
...
let joinusEn = [
  {
    ...
    content:`
[Responsibilities]
1. Research and understand the development trend of blockchain technology, participate in the product planning of blockchain platform, and promote the implementation of application context;
2. Conducted detailed product feature planning and system prototype design, and assisted the R&D team to understand and master requirements;
3. Analysis of compatible products, user analysis and data analysis, and optimization of products in operation continuously.
[Job Requirements]
1. Have a knowledge of the whole blockchain market and understand the technical structure, including the advantages of the blockchain products released in the market and the advantages of the products to be developed at present;
2. Good communication and coordination ability, rigorous logical analysis ability and certain technical understanding ability;
3. Familiar with the overall implementation process of Internet products, including demand analysis and product release;
4. Three years or more experience in Internet products, with experience of product in relevant industry is preferred.
    `
},{
  title:"Interaction Designer",
  content:`
[Responsibilities]
1. Conduct the interactive design of enterprise service products, provide global design solutions, and be responsible for the final user experience of the products;
2. Conduct online and offline promotion, marketing activities, carry out related creative design work (graphic design and mobile web design) 
3. Participated in the standard construction of the company's brand VI and related visual system.
[Job Requirements]
1. Have a deep understanding of user experience, interactive operation process and user requirements;
2. Can make product prototypes according to requirements documents, and have good views on style of Internet product;
3. Have a deep understanding of interaction design and can independently support the interaction design of company products;
4. Graduated from the major of design, more than 1 year of experience in UI design, and have superior tactile sensitivity and understanding of UI design trends.
  `
},{
  title:"Senior Java Engineer",
  content:`
[Responsibilities]
1. Participated in demand analysis, design, development and optimization of mobile terminal related projects; 
2. Complete the core coding of the project to ensure the development progress and quality of the system; 
3. Discover and solve existing problems in the operation of the system;
[Job Requirements]
1. Have a deep understanding of fault tolerance, high concurrency and low latency of large systems;
2. Rich experience in Webservice and Restful API design;
3. Have a strong interest in open source technologies, such as SpringBoot, SpringCloud, Zookeeper, etc.
4. Rich practical experience in JVM tuning, proficient in VisualVM, JMC, DTrace, etc.; 
5. More than 5 years of software development experience, more than 3 years of experience in J2EE system; Experience in Internet distributed projects is preferred.   Bachelor degree or above in computer science or related field.
  `
},{
  title:"Web Front-end Engineer",
  content:`
[Responsibilities]
1. Design and develop front-end components;
2. Responsible for the implementation of front-end product performance and code optimization to ensure the user experience of the product;
3. Ensure the speed and quality of rapid iterative development.
[Job Requirements]
1. Strong learning ability, proactive, good ability to analyze and solve problems;
2. Proficient in angularjs, HTML5/CSS3, vue and other technologies, and familiar with common front-end framework principles;
3. Bachelor degree or above in computer related field, more than 5 years experience in Web product development.
  `
},{
  title:"Advanced Specialist Risk Management",
  content:`
[Responsibilities]
1. Responsible for risk management of all businesses of the company and provide compliance risk control consulting;
2. Verify the authenticity, legality, accuracy and comprehensiveness of project data;
3. Conduct on-site investigation of the project, complete the corresponding risk control report, and put forward suggestions and controllable plans;
4. Put forward risk early warning for risk projects, timely report to the company, and participate in the disposition of risk events;
5. Collect and sort out relevant national or local laws and regulations, and put forward reasonable suggestions on risk management.
[Job Requirements]
1. Work experience in risk control, credit and auditing is preferred;
2. Have certain knowledge of economy, finance, law and other fields as well as other common industries, have strong analytical and learning ability, and have risk identification and judgment ability;
3. Major in finance, economy, finance, law, accounting and risk management, bachelor degree or above, more than 5 years work experience.
  `
}]
//法律声明
let copyrightEn = {
...
module.exports = {
    joinus:language == "en"?joinusEn:joinus,
