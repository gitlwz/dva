...
2.熟悉互联网产品整体实现过程，包括从需求分析到产品发布。有敏锐的市场洞察能力，严密的逻辑分析能力，良好的沟通协作能力，以及一定的技术理解能
  力；
...
A. 身份信息。
   该信息可以帮助我们验证阁下是否有资格注册为本网站会员， 包括但不限于阁下的名字、阁下的邮寄地址、居住地址、阁下所属国家或政府签发的其他具
   有证明阁下身份信息的不同的证书以及涉及到的号码及所有其他可帮助我们验证阁下身份的信息（以下合称为“身份信息” ）。
B. 服务信息。
   该信息帮助我们与阁下联系并顺利为阁下提供服务，包括但不限于阁下的电话号码、有效的电子邮件地址、邮寄地址、传真号码以及阁下的借记卡信息或其
   他帐户信息（以下合 称为“服务信息” ）。
2．当阁下使用本网站时，表示阁下同意我们开始使用cookies来追踪阁下的每一个动作，并收集和记住阁下留下的所有信息，其中包括但不限于阁下的IP地
   址，地理位置及其他资料。
...
4．如果阁下访问了在本网站上的其他第三方网站或合作的第三方的任何链接，表示阁下同意并遵守该第三方网单独和独立的隐私政策。我们对这些网站或合作
   方的内容及活动不承担任何责任。
...
D．政府机关、事业单位等合作的数据分析；
E．满足个性化阁下的用户设置及体验
F．处理交易（阁下的信息，无论是公共或私人的，未经阁下的同意不会以任何理由被出售、交换、转移，或提供给任何其他公司，但除了为完成阁下所要求的
   交易的明确目的之外 ）；
G．定期发送电子邮件（阁下提供订单处理的电子邮件地址，除了偶尔接收我们的新闻，更新，相关产品或服务的信息等，可用来向阁下发送信息和更新有关阁
   下的订单）；
H．满足本网站用户协议规定的其他目的和为了满足该等目的的所有合法途径。
3．我们不会向其他方出售、交易或以其他方式转让信息或允许他人收集、使用信息，但不包括以下其他方和以下信息：我们的关联方、帮助我们经营我们的网
   站、开展业务、或者向阁下提供服务的受信任的第三方，前提是这些当事方同意将这些信息保密；当我们相信披露的信息是适当的，是遵守法律、法规、规
   章制度的或来自于法院或他主管当局的命令、执行我们的网站策略，正常运行网站所需要，关联方提供服务所需或保护我们或他人的权利、财产或安全的。
   但是，阁下的信息不会提供给其他方进行营销，广告或其他用途。
...
3．当阁下到访我们网站时, 我们通过cookies使用Google Stats去记录我们的业绩以及核对在线广告的效果。只有当阁下使用阁下的电脑进入我们网站
   时,Cookie才能够被发送到阁下的电脑硬盘上。
...
九、关于如何与我们沟通
1. 我们只通过本网站上显示的有效的联系方式发布公告和信息或在本网站张贴公告，所以我们对由于阁下信任了未通过以上方式获得的信息而产生的任何损失
   不承担责任。
2. 如果阁下有任何要求和意见，阁下可以通过电子邮件support@sundax.top，这是唯一有效和官方电子邮件，所以我们对阁下未使用有效的联系方式，任何
   作为或不作为不承担责任。
...
二、【总则】
1.阁下在使用本网站提供的各项服务之前，应仔细阅读本协议。如有不理解之处或其他必要，请咨询专业律师。如阁下不同意本协议及/或随时对其的修改，请
  阁下立即停止使用网站提供的服务或不再登陆。
2.阁下一旦登陆本网站、使用我们的任何服务或任何其他类似行为即表示阁下已了解并完全同意本协议各项内容，包括网站对本协议随时所做的任何修改。
3.阁下通过按照本网站的要求填写相关信息，并经过其他相关程序后成功注册可以成为我们的会员。在进行注册过程中点击“同意”按钮，即表示阁下以电子签
  署的形式与公司达成协议；或阁下在使用网站过程中点击任何标有“同意”或类似意思的按钮的行为或以其他本网站允许的方式实际使用我们提供的服务时，
  均表示阁下完全了解、同意且接受本协议项下的全部条款的约束，无阁下手写的书面签字就本协议对阁下的法律约束力无任何影响。
4.成为本网站的会员后，阁下将获得一个会员帐号和密码，并由会员负责保管；会员应当对以其阁下帐号进行的所有活动和事件负法律责任。
5.只有成为本网站的会员，才可使用我们提供的数字资产交易平台进行交易，享受网站规定的会员服务；会员外的其他人只可使用登陆、浏览网站和其他一些
  网站规定可获得的服务。
...
(6)确认阁下已年满十六周岁或根据可适用的法律规定的具有可订立合同的法定年龄。阁下在网站的注册、销售或购买、发布信息等接受网站服务的行为应当符
   合对阁下有管辖权的主权国家或地区相关法律法规，并有充分的能力接受这些条款，并订立交易，使用本网站进行数字资产交易。
(7)本协议只是就阁下与我们之间达成的权利义务关系进行约束，并不涉及本网站用户之间、其他网站与阁下之间因数字资产交易而产生的法律关系及法律纠
   纷。

三、【协议修订】
1.我们保留实时修订本协议、并以网站公示的方式进行公告、不再单独通知阁下的权利。变更后的协议会在本协议首页标注变更时间，一经在本网站公布，立
  即自动生效。
2.阁下应实时浏览及关注本协议的更新时间及变更内容，如阁下不同意相关变更，应当立即停止使用本网站服务；如阁下继续使用本网站服务，即表示阁下接
  受并同意经修订的协议的约束。
...
7.阁下了解和理解此投资有可能导致部分损失或全部损失，所以阁下应以能承受的损失程度来决定投资的金额。阁下了解和理解数字资产会产生衍生风险，所
  以如有任何疑问，建议先寻求理财顾问的协助。
8.阁下应慎重考虑并用清晰的判断能力去评估自己的财政状况及上述各项风险而做出任何买卖数字资产的决定，并承担由此产生的全部损失。我们对此不承担
  任何责任。

五、【网站规则】
1.网站唯一官方对外信息公布平台是https://www. allwin.world 。
2.阁下了解本网站仅作为阁下获取数字资产信息、寻找交易方、就数字资产的交易进行协商及开展交易的场所，本网站不参与阁下的任何交易。故阁下应自行
  谨慎判断确定相关数字资产及/或信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。
3.本网站的任何意见、消息、探讨、分析、价格、建议和其他资讯均是一般的市场评论，并不构成投资建议。我们不承担任何因依赖该资讯直接或间接而产生
  的损失，包括但不限于任何利润损失。
4.我们已采取合理措施确保网站资讯的准确性，但并不能保证其准确性程度，亦不会承担任何因本网站上的资讯或因未能链结互联网、传送或接收任何通知和
  信息时的延误或失败而产生的直接或间接损失。
5.如果公司根据其单方判断认为阁下违反了本协议，或者根据阁下所在管辖区域的法律认为本网站提供的服务或者阁下使用本网站提供的服务的行为是非法的
  ，公司有权随时暂停或终止阁下的账户，或者暂停或终止阁下使用本网站提供的服务或数字资产交易。禁止位于美国的任何人使用本网站提供的服务。
6.本网站任何服务均不接受信用卡支付。
7.禁止使用本网站从事洗钱、走私、商业贿赂等一切非法交易活动。若发现此类事件，网站将采取各种可行手段，包括但不限于冻结账户、通知相关权力机关
  等。我们不承担由此产生的所有责任，并保留向相关人士追究责任的权利。
8.禁止使用本网站进行恶意操纵市场、不正当交易等一切不道德交易活动。若发现此类事件，网站将对所有恶意操纵价格、恶意影响交易系统等不道德的行为
  采取警告、限制交易、关停账户等预防性地保护措施，我们不承担由此产生的所有责任并保留向相关人士追究责任的权利。

六、【网站的权利和义务】
1.如阁下不具备本协议约定的注册资格，则本网站有权拒绝阁下的注册；对已注册的，则有权注销阁下的会员账号。网站保留向阁下或阁下的有权代理人追究
  责任的权利。同时，网站保留其他任何情况下决定是否接受阁下注册的权利。
2.如发现账户使用者并非初始注册人时，本网站有权中止或终止该账户的使用。
3.本网站通过技术检测、人工抽检等检测方式合理怀疑阁下提供的信息错误、不实、失效或不完整时，有权通知阁下更正、更新信息或中止、终止为其提供服
  务。本网站有权在发现网站上显示的任何信息存在明显错误时，对信息予以更正。
4.本网站保留随时修改、中止或终止服务的权利；行使修改或中止服务的权利不需事先告知阁下；终止一项或多项服务的，自网站发布终止公告之日终止生
  效。
...
9.本网站有权根据阁下所属主权国家或地区的法律法规、规则、命令等规范的要求，向阁下要求提供更多的信息或资料等，并采取合理的措施以符合当地的规
  范之要求，阁下有义务配合；本网站有权根据阁下所属主权国家或地区的法律法规、规则、命令等规范的要求，暂停或永久停止对阁下开放网站及其部分或
  全部服务。

七、【注册】
1.注册资格
  阁下确认并承诺：
(1)在完成注册程序或以其他本网站允许的方式实际使用网站提供的服务时，阁下应当是具备可适用的法律规定的可签署本协议及使用本网站服务应具有的能力
   的自然人、法人或其他组织。
(2)阁下一旦点击同意注册按钮，即表示阁下自身或阁下的有权代理人已经同意该协议内容并由其代理注册及使用本网站服务。若阁下不具备前述主体资格，则
   阁下及阁下的有权代理人应承担因此而导致的一切后果，且公司保留注销或永久冻结阁下账户，并向阁下及阁下的有权代理人追究责任的权利。
2.注册目的
  阁下确认并承诺：
  阁下进行本网站注册并非出于违反法律法规或破坏数字资产交易秩序的目的。
3.注册流程
(1)阁下同意根据本网站用户注册页面的要求提供有效电子邮箱、手机号码等信息，阁下可以使用阁下提供或确认的邮箱、手机号码或者网站允许的其它方式登
   陆进入网站。
(2)按照不同法域相关法律法规的规定，阁下必须提供阁下的真实姓名、身份证件等法律法规及隐私条款及反洗钱条款规定的相关信息并不断更新注册资料，符
   合及时、详尽、准确的要求。所有原始键入的资料将引用为注册资料。阁下应对该等信息的真实性、完整性和准确性负责，并承担因此产生的任何直接或间
   接损失及不利后果。
(3)如阁下所在主权国家或地区的法律法规、规则、命令等规范对手机号码有实名要求，阁下同意提供注册的手机号码是经过实名登记的。如阁下不按照规定提
   供，因此给阁下带来的任何直接或间接损失及不利后果均应由阁下承担。
...
2.服务规则 
阁下承诺遵守下列网站服务规则：
(1)阁下同意对阁下的网站的账号、密码下发生的所有活动（包括但不限于信息披露、发布信息、网上点击同意或提交各类规则协议、网上续签协议或购买服务
   等）承担责任。
...
(5)当阁下发现网站账号、登陆密码、或资金密码、验证码被未经其授权的第三方使用，或存在其他账号安全问题时，应及时有效通知网站，要求网站暂停该账
   号的服务。
(6)本网站有权在合理时间内对阁下的此类请求采取行动，但对在采取行动前已经产生的后果（包括但不限于阁下的任何损失）不承担任何责任。
(7)阁下应当遵守法律法规、规章、及政策要求的规定，保证账户中所有数字资产来源的合法性。不得在本网站或利用网站服务从事非法或其他损害网站或第三
   方权益的活动，如发送或接收任何违法、违规、侵犯他人权益的信息，发送或接收传销材料或存在其他危害的信息或言论，未经网站授权使用或伪造网站电
   子邮件题头信息等。
(8)阁下在本网站进行数字资产交易时不得恶意干扰数字资产交易的正常进行、破坏交易秩序；不得以任何技术手段或其他方式干扰网站的正常运行或干扰其他
   用户对本网站服务的使用；不得以虚构事实等方式恶意诋毁本网站的商誉。
...
A.浏览交易信息
  阁下在本网站浏览交易信息时，应当仔细阅读交易信息中包含的全部内容，包括但不限于价格、委托量、手续费、买入或卖出方向， 阁下完全接受交易信息
  中包含的全部内容后方可点击按钮进行交易。
B.提交委托
  在浏览完交易信息确认无误之后阁下可以提交交易委托。阁下提交交易委托后，即阁下授权本网站代理阁下进行相应的交易撮合，本网站在有满足阁下委托
  价格的交易时将会自动完成撮合交易，而无需提前通知阁下。
C.查看交易明细
...
2.如阁下发生违反本协议或其他法律法规等情况，阁下须向我们赔偿至少200万美元及承担由此产生的全部费用（包括律师费等），如不够弥补实际损失，阁下
  须补全。
...
(7)数据的损坏或损失；
(8)购买替代产品或服务的成本；
(9)任何由于侵权（包括过失）、违约或其他任何原因产生的间接的、特殊的或附带性的损失或损害，不论这种损失或损害
   是否可以为我们合理预见；不论我们是否事先被告知存在此种损失或损害的可能性。
(1)条至(9)条均是彼此独立的。
...
3.我们对由于信息网络设备维护、信息网络连接故障、电脑、通讯或其他系统的故障、电力故障、天气原因、意外事故、罢工、劳动争议、暴
  乱、起义、骚乱、生产力或生产资料不足、火灾、洪水、风暴、爆炸、战争、银行或其他合作方原因、数字资产市场崩溃、政府行为、司法或行政机关的命
  令、其他不在我们可控范围内或我们无能力控制的行为或第三方的原因而造成的不能服务或延迟服务，以及造成的阁下的损失，我们不承担任何责任。
4.我们不能保证网站包含的全部信息、程序、文本等完全安全，不受任何病毒、木马等恶意程序的干扰和破坏。故阁下登陆、使用网站任何服务或下载及使用
  该下载的任何程序、信息、数据等均是阁下个人的决定，并自行承担风险及可能产生的损失。
5.我们对网站中链接的任何第三方网站的任何信息、产品及业务及其他任何形式的不属于我们的主体的内容等不做任何保证和承诺。阁下如果使用第三方网站
  提供的任何服务、信息及产品等均为阁下个人决定且承担由此产生的一切责任。
6.我们对于阁下使用网站服务不做任何明示或暗示的保证，包括但不限于网站提供服务的适用性、没有错误或疏漏、持续性、准确性、可靠性、适用于某一特
  定用途。同时，我们也不对网站提供的服务所涉及的技术及信息的有效性、准确性、正确性、可靠性、质量、稳定、完整和及时性作出任何承诺和保证。是
  否登陆、使用网站提供的服务是阁下个人的决定且自行承担风险及可能产生的损失。
7.我们对于数字资产的市场、价值及价格等不做任何明示或暗示的保证，阁下理解并了解数字资产市场是不稳定的，价格和价值随时会大幅波动或崩盘，交易
  数字资产是阁下个人的自由选择及决定且自行承担风险及可能产生的损失。
8.本协议中规定的保证和承诺是由我们就本协议和网站提供的服务的唯一保证和陈述，并取代任何其他途径和方式产生的保证和承诺，无论是书面的或口头的
  ，明示的或暗示的。所有这些保证和陈述仅仅代表我们自身的承诺和保证，并不保证任何第三方遵守本协议中的保证和承诺。
...
3.本协议终止后，阁下无权要求本网站继续向其提供任何服务或履行任何其他义务，包括但不限于要求网站为阁下保留或向阁下披露其原网站账号中的任何信
  息，向阁下或第三方转发任何其未曾阅读或发送过的信息等。
4.本协议的终止不影响守约方向违约方要求其他责任的承担。

十三、【知识产权】
1.SUNDAX是本网站中所有智力成果(包括但不限于商誉和商标、标志) 的知识产权权利人。网站的一切著作权、商标权、专利权、商业秘密等知识产权及其他
  合法权益，以及与网站相关的所有信息内容（包括文字、图片、音频、视频、图表、界面设计、版面框架、有关数据或电子文档等）均受法律法规和相应的
  国际条约保护，SUNDAX享有上述知识产权和合法权益，但相关权利人依照法律规定应享有的权利除外。未经SUNDAX书面同意，阁下不得为商业目的去复制、
  更改、拷贝、发送或使用下述任何材料或内容：包括但不限于网站标志、数据库、网站设计、文字和图表、软件、照片、录像、音乐、声音及其前述组合，
  软件编译、相关源代码和软件 (包括小应用程序和脚本) 。
2.阁下登陆本网站或使用网站提供的任何服务，均不视为我们向阁下转让任何知识产权。阁下不得将已发表于网站的信息以任何形式发布或授权其它网站（及
  媒体）使用。阁下在使用网站服务过程中不得非法使用或处分网站或他人的知识产权权利。
3.阁下接受本协议，即视为阁下主动将其在本网站发表的任何形式的著作权， 包括但不限于：复制权、发行权、出租权、展览权、表演权、放映权、广播权、
  信息网络传播权、摄制权、改编权、翻译权、汇编权以及应当由著作权人享有的其他可转让权利，无偿独家转让给本网站所有。网站有权利就任何主体侵权
  单独提起诉讼并获得全部赔偿。 
...
(2)在阁下使用本网站服务时，或访问网站网页时，网站自动接收并记录的阁下浏览器上的服务器数值，包括但不限于IP地址等数据及阁下要求取用的网页记
   录。
(3)本网站收集到的阁下在网站进行交易的有关数据，包括但不限于交易记录。
(4)本网站通过合法途径取得的其他阁下个人信息。
2.信息使用
(1)不需要阁下额外的同意，阁下在本网站注册成功即视为阁下同意网站收集并使用其在网站的各类信息，如1.(1)~(4)条所列，阁下了解并同意，网站可以将
   收集的阁下信息用作包括但不限于下列用途：
A.向阁下提供本网站服务；
B.基于主权国家或地区相关主管部门的要求向相关部门进行报告；
C.在阁下使用网站服务时，本网站将阁下的信息用于身份验证、客户服务、安全防范、诈骗监测、市场推广、存档和备份用途，或与第三方合作推广网站等合
  法用途，确保网站向阁下提供的产品和服务的安全性；
...
(2)本网站不会向其他任何人出售或出借阁下的个人信息，除非事先得到阁下的许可；也不允许任何第三方以任何手段收集、编辑、出售或无偿传播阁下的个人
   信息。
(3)本网站对所获得的客户身份资料和交易信息等进行保密，不得向任何单位和个人提供客户身份资料和交易信息，应相关主权国家或地区法律法规、政令、命
   令等规定要求提供的除外。
...
一、导言：
1.我们保证审慎遵守“了解你的客户和反洗钱”相关的法律法规且不得故意违反该《了解你的客户和反洗钱政策》。在我们合理控制的范围内我们将采取必要的
  措施和技术为阁下提供安全的服务，尽可能使阁下免于遭受犯罪嫌疑人的洗钱行为带来的损失。
2.我们的“了解你的客户和反洗钱政策”是一个综合性的国际政策体系，包括阁下隶属的不同法律辖区的“了解你的客户和反洗钱政策”。我们健全合规的框架以
  确保我们在本地和全球层面均符合监管要求和监管水平，并确保网站持续性运行。
...
A.个人基本信息：阁下的姓名，住址（及永久住址，如果不同）,出生日期及国籍等可获得的其他情况。身份验证应该是根据官方或其他类似权威机构发放的文
  件，比如护照，身份证或其他不同的辖区要求的和引发的身份证明文件。阁下提供的地址将使用适当的方法进行验证，比如检查乘用交通工具的
  票据或利率票据或检查选民登记册等。
...
(3)证明文件的副本一般应核和原始凭证进行核对。然而，如果某个可信赖的合适的认证人可证明该副本文件是原始文件准确而全面的复制的，该副本可接受。
   这样的认证人包括大使、司法委员、地方治安官等。
(4)对识别最终受益人和账户控制权的要求是确定哪些个人最终所有或控制直接客户，和/或确定正在进行的交易是由他人代为执行。
(5)如果最终受益人是企业，则大股东的身份（例如那些持有10％或以上的投票权益）应被验证。一般来说，持股25％会被认定为正常风险内，其股东身份须验
   证；持股10%或拥有更多的投票权或股票时被认定为高风险的情况，股东身份须验证。
...
4.我们保留拒绝来自于不符合国际反洗钱标准辖区的人或可被视为政治公众人物的人的注册申请，我们保留随时暂停或终止根据我们自身判断为可疑交易的交
  易，但我们这样做并不违反对阁下的任何义务和责任。`
}
