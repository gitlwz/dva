    ...
    render() {
        return <div style={{ height: '100%' }}>
            <Spin spinning={this.props.markLoading}>
                <TradeComponent dataList={this.props.sellList.slice(0, 7)} handleOk={price => this.props.handleOk({ sellPrice: price })} />
                <div style={{ height: '1px', width: '100%', background: '#233044', margin: '5px 10px' }}></div>
                <TradeComponent dataList={this.props.buyList.slice(0, 7)} titleList={[]} handleOk={price => this.props.handleOk({ buyPrice: price })} />
            </Spin>
        </div>
    }
}
