                            ...
                            <Form>
                                ...
                                >
                                    {getFieldDecorator('amount', {
                                        ...
                                        <InputNumber step={0.01} precision={precision} max={this.state.select.extractable * 1 || 0} min={this.state.select.withdrawalAmount * 1 || 0} placeholder="提现金额" className={style.inputerNumber} />
                                    )}
