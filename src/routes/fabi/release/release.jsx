                ...
                <div className={styles.root}>
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.Release}>
                            ...
                            <p>单价</p>
                            <Input suffix={<span>BTC</span>} value={this.state.price} onChange={e => this.reloadState(e.target.value, "price")} />
                            <p>最小交易额</p>
                            <Input suffix={<span>BTC</span>} value={this.state.limitVolume} onChange={e => this.reloadState(e.target.value, "limitVolume")} />
